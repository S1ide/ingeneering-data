...
my_file = os.path.join(os.path.dirname(__file__), os.path.abspath('resources/task_1_var_43_item.text'))
res_file_sorted = os.path.join(os.path.dirname(__file__), os.path.abspath('results/res_sort.json'))
res_file_filter = os.path.join(os.path.dirname(__file__), os.path.abspath('results/res_filter.json'))
db_file = os.path.join(os.path.dirname(__file__), os.path.abspath('results/db'))
...
def read_file():
    data = []
    with open('resources/task_1_var_43_item.text', encoding='utf-8') as file:
