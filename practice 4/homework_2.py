...
first_file = os.path.join(os.path.dirname(__file__), os.path.normpath('resources/task_1_var_43_item.text'))
second_file = os.path.join(os.path.dirname(__file__), os.path.normpath('resources/task_2_var_43_subitem.csv'))
res_file_filter = os.path.join(os.path.dirname(__file__), os.path.normpath('results/res_filter2.json'))
db_file = os.path.join(os.path.dirname(__file__), os.path.normpath('results/db2'))
...
def read_second_file():
    ...
    with open(second_file, "r", encoding='utf-8') as input:
...
charact_security(db, 'Утятник 92')

city_popul(db, "Верфь 87")
