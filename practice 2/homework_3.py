...
with open("resources/products_43.json") as f:
    data = json.load(f)
...
with open("results/products_result_43.json", "w") as r_json:
    r_json.write(json.dumps(result))

with open("results/products_result_43.msgpack", "wb") as r_msgpack:
    r_msgpack.write(msgpack.dumps(result))

json_size = os.path.getsize('results/products_result_43.json')
msgpack_size = os.path.getsize('results/products_result_43.msgpack')
